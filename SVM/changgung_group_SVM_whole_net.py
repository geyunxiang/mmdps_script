...
No feature selection method is employed here to test the classification
power of whole brain connections
"""
...
if __name__ == '__main__':
	...
	for xidx in range(atlasobj.count):
		...
		for yidx in range(xidx+1, atlasobj.count):
			normalCList = result_utils.getAllFCAtIdx(xidx, yidx, ChanggungHealthyNets)
			X1 = np.insert(X1, 0, normalCList, axis = 1)
			patientCList = result_utils.getAllFCAtIdx(xidx, yidx, ChanggungPatientNets)
